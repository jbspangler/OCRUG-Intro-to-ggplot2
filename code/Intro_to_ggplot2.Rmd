...
# Base R Plots (Scatterplot)

```{r, fig.height=5, fig.width=5}

plot(x=Iris_Data$Sepal.Length,
...
# Base R Plots (Histogram)

```{r, fig.height=5, fig.width=5}

hist(x=Iris_Data$Sepal.Length)

```

---

# Base R Plots (Boxplots)
...
# ggplot2 Scatterplots -  Add a diagonal line
...
# ggplot2 Scatterplots - Add color
